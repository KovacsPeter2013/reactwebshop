...
const ProductDetails = () => {  
    ...
    axios.get(`/api/viewsingleproduct/${categorySlug}/${productSlug}`).then(res =>{      
...
var showProduct = '';
showProduct = product.map((item, key) => {
  return(
        ...
        <div className="row">
          <div className="col-12 col-sm-6">
            ...
            <div className="col-12 product-image-thumbs">
              <div className="product-image-thumb active"><img  src={`http://localhost:8000/${item.image}`} className="w-100" alt={item.name}/></div>
              <div className="product-image-thumb" ><img  src={`http://localhost:8000/${item.image}`} className="w-100" alt={item.name}/></div>
              <div className="product-image-thumb" ><img  src={`http://localhost:8000/${item.image}`} className="w-100" alt={item.name}/></div>
              <div className="product-image-thumb" ><img  src={`http://localhost:8000/${item.image}`} className="w-100" alt={item.name}/></div>
              <div className="product-image-thumb" ><img  src={`http://localhost:8000/${item.image}`} className="w-100" alt={item.name}/></div>
            </div>
          ...
          <div className="col-12 col-sm-6">
            <h3 className="my-3">LOWA Mens Renegade GTX Mid Hiking Boots Review</h3>
        ...
        <div className="row mt-4">
          <nav className="w-100">
            <div className="nav nav-tabs" id="product-tab" role="tablist">
              <a className="nav-item nav-link active" id="product-desc-tab" data-toggle="tab" href="#product-desc" role="tab" aria-controls="product-desc" aria-selected="true">Leírás</a>
              <a className="nav-item nav-link" id="product-comments-tab" data-toggle="tab" href="#product-comments" role="tab" aria-controls="product-comments" aria-selected="false">Vélemények</a>
              <a className="nav-item nav-link" id="product-rating-tab" data-toggle="tab" href="#product-rating" role="tab" aria-controls="product-rating" aria-selected="false">Értékelések</a>
            </div>
          </nav>
